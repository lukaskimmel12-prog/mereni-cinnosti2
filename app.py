...
render_html(
    ...
    <style>
        ...
        @media (max-width: 800px) {{
            ...
            @keyframes forklift-left-drive {{
                0%, 12% {{ left: 0; }}
                45%, 55% {{ left: calc(100% - 72px); }}
                88%, 100% {{ left: 0; }}
            }}

            @keyframes forklift-right-drive {{
                0%, 12% {{ right: 0; transform: scaleX(-1); }}
                45%, 55% {{ right: calc(100% - 72px); transform: scaleX(-1); }}
                88%, 100% {{ right: 0; transform: scaleX(-1); }}
            }}
        }}
